	...
	<form action="detailUser.do" method="post" id="detail_form">
		...
		<ul>
			...
			<li>
				...
				<input type="text" id="name" name="name" value="${member.name}" maxlength="10">
			</li>
			<li>
				<label for="phone">전화번호</label>
				<input type="text" id="phone" name="phone" value="${member.phone}" maxlength="15">
			</li>
			<li>
				<label for="email">이메일</label>
				<input type="email" id="email" name="email" value="${member.email}" maxlength="50">
			</li>
			<li>
